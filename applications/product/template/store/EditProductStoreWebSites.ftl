...
<div class="screenlet">
    ...
    <div class="screenlet-body">
      <a href="/content/control/EditWebSite?productStoreId=${productStoreId}" class="buttontext">${uiLabelMap.ProductCreateNewProductStoreWebSite}</a>
            ...
            <#if storeWebSites?has_content>
              ...
              <#list storeWebSites as webSite>
                <tr valign="middle"<#if "1" == rowClass> class="alternate-row"</#if>>
                  <td><a href="/content/control/EditWebSite?webSiteId=${webSite.webSiteId}" class="buttontext">${webSite.siteName!} [${webSite.webSiteId}]</a></td>
