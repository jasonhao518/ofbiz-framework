          ...
          <#else> <#-- PURCHASE_ORDER -->
            ...
            <#if ownedFacilities?has_content>
              <#if !allShipments?has_content>
                  <li>
                     <form action="/facility/control/quickReceivePurchaseOrder" method="post">
                  ...
                  <li>
                    <form name="receivePurchaseOrderForm" action="/facility/control/quickReceivePurchaseOrder" method="post">
                      <input type="hidden" name="initialSelected" value="Y"/>
                      <input type="hidden" name="orderId" value="${orderId}"/>
                      <input type="hidden" name="purchaseOrderId" value="${orderId}"/>
