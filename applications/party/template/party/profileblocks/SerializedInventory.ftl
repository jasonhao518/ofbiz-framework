        ...
        <table id="serialized-inventory" class="basic-table" cellspacing="0" cellpadding="2">
            ...
            <tbody>
                <#list inventoryItemList as inventoryItem>
                    ...
                    <tr>
                        <td><a href="/facility/control/EditInventoryItem?inventoryItemId=${inventoryItem.inventoryItemId}" class="linktext">${inventoryItem.inventoryItemId}</a></td>
                        <td>
                            <#if product?has_content>
                                ...
                                <#if product?has_content>
                                    ...
                                    <a href="/catalog/control/EditProduct?productId=${product.productId}">${productName?default(product.productId)}</a>
                                </#if>
                            </#if>
                        </td>
